namespace ADondeIr.Common.Extensions
{
    ...
    public static class DateTimeExtension
    {
        ...
        public static DateTime ConverToTimeZone(this DateTime datetime, string utc, bool reserse = false)
        {
            return reserse ? TimeZoneInfo.ConvertTimeToUtc(datetime, TimeZoneInfo.FindSystemTimeZoneById(utc)) : TimeZoneInfo.ConvertTimeFromUtc(datetime, TimeZoneInfo.FindSystemTimeZoneById(utc));
        }
